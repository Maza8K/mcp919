...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            if (this.thePlayer == null)
            {
                this.thePlayer = this.playerController.createPlayer(worldClientIn, new StatFileWriter()); //func_178892_a = createPlayer
    ...
    public void setDimensionAndSpawnPlayer(int dimension)
    {
        ...
        this.thePlayer = this.playerController.createPlayer(this.theWorld, this.thePlayer == null ? new StatFileWriter() : this.thePlayer.getStatFileWriter());//func_178892_a = createPlayer
